  ...
  return (
    <div className='main overflow-x-hidden'>
      ...
      <div className='container mx-auto px-10 xl:p-0'>
        ...
        <div className='lg:text-2xl text-lg mt-12 md:mt-16 mb-4 w-3/4 lg:w-full xl:my-20 xl:mt-32 leading-loose text-blue-special'>
        ...
        <Section classes='flex flex-wrap'>
          <div className='lg:w-1/2 text-md py-6 leading-8'>
            <p>
              ...
              Abseits der Arbeit bin ich für ein Bier am Abend genauso wie für einen Brunch am Sonntag Morgen zu haben. Zudem reise ich gerne. Nach mehreren Zielen in Nordamerika, Lateinamerika und Europa wird hoffentlich auch bald Asien &mdash; in erster Linie Japan &mdash; dran sein. Konnichi wa!
            </p>
          </div>
          ...
          <div className='lg:w-1/2 text-md py-6 leading-8'>
            <p>
              Nach meiner Ausbildung zum <strong>Mediengestalter</strong> und dem <strong>Dualen Studium</strong> im Studiengang Onlinemedien an der DHBW Mosbach konnte ich bereits über <strong>3,5 Jahre Berufserfahrung</strong> sammeln und bin aktuell in Stuttgart als <strong>Frontend Developer</strong> tätig. Ich baue Webseiten und entwickle Komponenten auf Basis von UX Konzepten, Photoshop- und Sketchvorlagen.<br /><br />
              Ich habe bereits an unterschiedlichen Projekten für Bosch, TRUMPF, Porsche und weiterer Kunden gearbeitet. Außerdem bin ich innerhalb eines Projektes als <strong>technischer Ansprechpartner</strong> die Schnittstelle zwischen Projektmanager und Development.
            </p>
          </div>
        </Section>
        ...
        <Section>
          <TextContent headline='Projekte'>
            ...
            <Project title='Umbau der Messe App zur Desktop Anwendung' types={['Entwicklung', 'techn. Ansprechpartner']} stack={['React', 'Electron', 'HTML / SASS']} customer='Bosch' video='bosch-desktop.mp4' textRight={true}>
            ...
            <Project title='Umsetzung einer pflegbaren Speisekarte' types={['Entwicklung']} stack={['PHP / MySQL', 'HTML / SASS']} customer='Restaurant Picknick' image='picknick.png' link='https://mypicknick.it/menu.php'>
            ...
            <Project title='Component Library mit Storybook' types={['Entwicklung']} stack={['StencilJS', 'Storybook', 'Jest']} customer='TRUMPF' image='trumpf-story.png' textRight={true}>
            ...
            <Project title='Portfolio Website' types={['Planung', 'Entwicklung']} stack={['GatsbyJS', 'React', 'Styled Components', 'TailwindCSS']} customer='-' image='portfolio.png' github='https://github.com/ItsTommyGun/portfolio'>
