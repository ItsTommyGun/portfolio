  ...
  const HeadValues = () => {
    return (
      <Helmet>
        ...
        <meta
          name="description"
          content="Frontend Entwicklung mit React, Styled Components und mehr in Heidelberg und Stuttgart. Interesse an einer Zusammenarbeit?"
        />
        <meta
          name="keywords"
          content="frontend, stuttgart, ludwigsburg, esslingen, web, developer, entwickler, javascript"
        />
